<!-- Header -->
<header class="bg-black shadow-sm border-b px-10">
  <div class="container mx-auto px-6 py-8">
    <div class="flex items-center justify-between">
      <!-- Logo -->
      <div class="flex items-center space-x-2">
      <img src="/public/assets/images/logo.png" alt="Imperial Housing" class="w-24 h-24 object-contain">
      </div>
      
      <!-- Navigation -->
      <nav class="hidden md:flex items-center space-x-8">
  <a href="/src/pages/index.php" class="nav-link text-white hover:brand-yellow transition-colors duration-200">Home</a>

        <!-- Services dropdown -->
        <div class="relative group">
          <button id="servicesBtn" aria-expanded="false" class="text-white hover:brand-yellow transition-all duration-200 flex items-center space-x-2 focus:outline-none focus:brand-yellow">
            <span>Services</span>
          ...
          <div id="servicesMenu" class="opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 absolute right-0 mt-2 w-56 bg-black text-white rounded-md shadow-lg ring-1 ring-white ring-opacity-20 z-50 py-1 transform translate-y-1 group-hover:translate-y-0">
            <a href="/src/pages/hmo.php" class="block px-4 py-2 text-sm text-white hover:brand-yellow transition-colors duration-150">HMO (Supported Accomodation)</a>
            <a href="/src/pages/design.php" class="block px-4 py-2 text-sm text-white hover:brand-yellow transition-colors duration-150">Design & Renovation</a>
          </div>
        </div>

  <a href="/src/pages/properties.php" class="nav-link text-white hover:brand-yellow transition-colors duration-200">Properties</a>
  <a href="/src/pages/tenants.php" class="nav-link text-white hover:brand-yellow transition-colors duration-200">Tenants</a>
  <a href="/src/pages/about.php" class="nav-link text-white hover:brand-yellow transition-colors duration-200">About</a>
  <a href="/src/pages/contact.php" class="nav-link text-white hover:brand-yellow transition-colors duration-200">Contact</a>
      </nav>
  ...
  <div id="mobileMenuPanel" class="w-full max-w-md bg-white rounded-2xl shadow-2xl ring-1 ring-black ring-opacity-5 overflow-hidden pointer-events-auto opacity-0 scale-95 translate-y-2 transform transition-all duration-300 ease-out">
        ...
        <div class="px-6 py-4 space-y-2">
          ...
          <div id="mobileServicesMenu" class="pl-4 hidden">
            <a href="/src/pages/hmo.php" class="block py-1 text-gray-600 hover:brand-yellow">HMO (Supported Accomodation)</a>
